...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Premium Monsoon Sale Bundle Offer */}
      <MansoonOffer />

      {/* Categories Section - Dark section, light cards, clean arrows */}
      <ExploreCollections />
        ...
        <section className="py-6 sm:py-8 md:py-10 bg-muted/50">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-0">
              ...
              <AnimatedSection delay={0.2} direction="up">
                <div className="flex flex-col items-center text-center p-2 sm:p-3 md:p-4">
                  <Truck className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 mb-2 md:mb-3 text-primary" />
                  <h3 className="font-medium text-xs sm:text-sm">
                    Free Delivery
                  </h3>
                </div>
